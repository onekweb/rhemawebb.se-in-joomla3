<?php
/**
* @version   $Id: styledeclaration.php 12180 2013-07-22 09:16:56Z arifin $
...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	$css = $this->buildLogo();
        ...
        // Less Variables
    $lessVariables = array(
        'header-background'     =>$gantry->get('header-background',     '#25262B'),
        'showcase-background'   =>$gantry->get('showcase-background',   '#00ABF0'),
        'feature-background'    =>$gantry->get('feature-background',    '#7DCDE4'),
        'utility-background'    =>$gantry->get('utility-background',    '#2E2F31'),
        'main-body'             =>$gantry->get('main-body',             'dark'),
        'main-background'       =>$gantry->get('main-background',       '#495565'),
        'main-accent'           =>$gantry->get('main-accent',           '#009BDD'),
        'footer-background'     =>$gantry->get('footer-background',     '#313842')
    );

    $positions = array('feature-customfeature', 'utility-customutility', 'footer-customfooter');
    $source = "";    
