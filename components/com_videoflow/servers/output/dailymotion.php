...
$embedcode = '<div class="vfrespiframe"><iframe src="http://www.dailymotion.com/embed/video/'.$media->file.'" width="'.$vparams->playerwidth.'" height="'.$vparams->playerheight.'" frameborder="0"></iframe></div>';
